 ...
 var formannonceedit=document.getElementById("edit_membre_form");
    ...
    $cf.blur(function(e){
        ...
        if (phone.length != 8)
        {
            ...
            $('#edit_telephone_membre').val('');
            $('#edit_telephone_membre').focus();
        }else{
       ...
       $telephoneIIvalidation = $('#edit_telephoneII_membre');
    $telephoneIIvalidation.blur(function(e){
        phonee = $(this).val();
        phonee = phonee.replace(/[^0-9]/g,'');
        if (phonee.length != 8)
        {
            document.getElementById('edittelephoneII').textContent='telephone doit etre 8 numero. ';
            $('#edit_telephoneII_membre').val('');
            $('#edit_telephoneII_membre').focus();
        }else{

           document.getElementById('edittelephoneII').textContent='';
                 ...
                 $fixvalidation = $('#edit_fix_membre');
    $fixvalidation.blur(function(e){
        fixs = $(this).val();
        fixs = fixs.replace(/[^0-9]/g,'');
        if (fixs.length != 8)
        {
            document.getElementById('editfix').textContent='numero fix doit etre 8 numero. ';
            $('#edit_fix_membre').val('');
            $('#edit_fix_membre').focus();
        }else{

           document.getElementById('editfix').textContent='';
                   ...
                   $cpvalidation = $('#edit_cp_membre');
    $cpvalidation.blur(function(e){
        cps = $(this).val();
      
        if (cps.length != 4)
        {
            document.getElementById('editcp').textContent='code postale invalide. ';
            $('#edit_cp_membre').val('');
            $('#edit_cp_membre').focus();
        }else{
